      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div className="max-w-md">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed mb-6">
              Your premiere destination for reading Nano Machine manga online.
              High quality scans, fast loading, and the latest chapter updates.
            </p>
            <p className="text-xs text-gray-400 dark:text-gray-600">
              Fan Project. Not affiliated with Jeong Jun-Gyu & Keum Gang-Bul-Gae or Naver Webtoon.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 md:justify-items-end">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                ...
                <li><a href="mailto:Support@nanomachinemanga.online" className="hover:text-bb-blue transition-colors">Contact</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 dark:border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-400 dark:text-gray-600 text-center md:text-left">
            &copy; {currentYear} Nano Machine Manga. All rights reserved.
          </p>
