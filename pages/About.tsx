...
const About: React.FC = () => {
    return (
        <div className="max-w-4xl mx-auto px-4 py-16 min-h-screen">
            <SEOHead
                title="About Us - Nano Machine Manga"
                description="Learn more about Nano Machine Manga, our mission, and why we are the best place to read Nano Machine manhwa online in English."
                canonicalUrl="https://www.nanomachinemanga.online/about"
            />
            ...
            <div className="prose dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 space-y-6">
                <p className="lead text-xl text-gray-600 dark:text-gray-400">
                    Welcome to <strong>Nano Machine Manga</strong>, the ultimate destination for fans of Jeong Jun-Gyu & Keum Gang-Bul-Gae's masterpiece.
                </p>

                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Our Mission</h2>
                <p>
                    Our mission is simple: to provide the best possible reading experience for Nano Machine fans worldwide. We believe that manga should be accessible, fast, and enjoyable to read on any device.
                </p>
                <p>
                ...
                <p>
                    ...
                    <br />
                    Email us at: <a href="mailto:Support@nanomachinemanga.online" className="text-bb-blue hover:underline">Support@nanomachinemanga.online</a>
                </p>

                <div className="bg-gray-100 dark:bg-white/5 p-6 rounded-xl mt-12 border border-gray-200 dark:border-white/10">
                    <p className="text-sm text-gray-500 dark:text-gray-400 italic">
                        <strong>Disclaimer:</strong> This website is a fan project and is not affiliated with Jeong Jun-Gyu & Keum Gang-Bul-Gae, Naver Webtoon, or their partners. All manga content and characters belong to their respective copyright owners.
                    </p>
                </div>
            </div>
        </div>
