...
const Characters: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <SEOHead
        title="Nano Machine Manga Characters - Database"
        description="Detailed profiles of Nano Machine Manga characters including Cheon Yeo-Woon, Nano and more."
      />
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed">
          Comprehensive database of every character in the Nano Machine manga. Learn about their sports, abilities, and relationships.
        </p>
      </div>
